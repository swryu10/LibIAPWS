...
double Lib97::get_param3a_temperature_ph(double pressure_in,
    ...
    for (int i = 1; i <= 31; i++) {
        double ppi_pow_I =
            get_pow_int(ppi + 0.240, coeff3aTph_I_[i]);
        double eta_pow_J =
            get_pow_int(eta - 0.615, coeff3aTph_J_[i]);

        fn_theta +=
            coeff3aTph_n_[i] * ppi_pow_I * eta_pow_J;
    }

    return temperature_ref3aTph_ * fn_theta;
}
...
double Lib97::get_param3b_temperature_ph(double pressure_in,
    ...
    for (int i = 1; i <= 33; i++) {
        double ppi_pow_I =
            get_pow_int(ppi + 0.298, coeff3bTph_I_[i]);
        double eta_pow_J =
            get_pow_int(eta - 0.720, coeff3bTph_J_[i]);

        fn_theta +=
            coeff3bTph_n_[i] * ppi_pow_I * eta_pow_J;
    }

    return temperature_ref3bTph_ * fn_theta;
}
...
double Lib97::get_param3_temperature_ps(double pressure_in,
    ...
    if (pressure_in < pressure_crit_) {
        ...
        if (entropy_in < entropy_sat_liq) {
            temperature_out =
                get_param3a_temperature_ps(pressure_in,
                                           entropy_in);
        } else if (entropy_in > entropy_sat_vap) {
            temperature_out =
                get_param3b_temperature_ps(pressure_in,
                                           entropy_in);
        } else {
            temperature_out = temperature_sat;
        }
    } else {
        if (entropy_in > 4.41202148223476 * 1.0e+3) {
            temperature_out =
                get_param3b_temperature_ps(pressure_in,
                                           entropy_in);
        } else {
...
double Lib97::get_param3a_temperature_ps(double pressure_in,
    ...
    for (int i = 1; i <= 33; i++) {
        double ppi_pow_I =
            get_pow_int(ppi + 0.240, coeff3aTps_I_[i]);
        double sig_pow_J =
            get_pow_int(sig - 0.703, coeff3aTps_J_[i]);

        fn_theta +=
            coeff3aTps_n_[i] * ppi_pow_I * sig_pow_J;
    }

    return temperature_ref3aTps_ * fn_theta;
}
...
double Lib97::get_param3b_temperature_ps(double pressure_in,
    ...
    for (int i = 1; i <= 28; i++) {
        double ppi_pow_I =
            get_pow_int(ppi + 0.760, coeff3bTps_I_[i]);
        double sig_pow_J =
            get_pow_int(sig - 0.818, coeff3bTps_J_[i]);

        fn_theta +=
            coeff3bTps_n_[i] * ppi_pow_I * sig_pow_J;
    }
...
void Lib97::set_coefficients() {
    ...
    enthalpy_ref3aTph_ = 2300. * 1.0e+3;

    coeff3aTph_I_[0] = 0;
    // backward T(p,h) coefficient region 3a I_i
    coeff3aTph_I_[1] = -12;
    coeff3aTph_I_[2] = -12;
    coeff3aTph_I_[3] = -12;
    coeff3aTph_I_[4] = -12;
    ...
    coeff3aTph_J_[0] = 0;
    // backward T(p,h) coefficient region 3a J_i
    coeff3aTph_J_[1] = 0;
    coeff3aTph_J_[2] = 1;
    coeff3aTph_J_[3] = 2;
    coeff3aTph_J_[4] = 6;
    ...
    coeff3aTph_n_[0] = 0.;
    // backward T(p,h) coefficient region 3a n_i
    coeff3aTph_n_[1] = -0.133645667811215 * 1.0e-6;
    coeff3aTph_n_[2] = 0.455912656802978 * 1.0e-5;
    coeff3aTph_n_[3] = -0.146294640700979 * 1.0e-4;
    coeff3aTph_n_[4] = 0.639341312970080 * 1.0e-2;
    coeff3aTph_n_[5] = 0.372783927268847 * 1.0e+3;
    coeff3aTph_n_[6] = -0.718654377460447 * 1.0e+4;
    coeff3aTph_n_[7] = 0.573494752103400 * 1.0e+6;
    coeff3aTph_n_[8] = -0.267569329111439 * 1.0e+7;
    coeff3aTph_n_[9] = -0.334066283302614 * 1.0e-4;
    coeff3aTph_n_[10] = -0.245479214069597 * 1.0e-1;
    coeff3aTph_n_[11] = 0.478087847764996 * 1.0e+2;
    coeff3aTph_n_[12] = 0.764664131818904 * 1.0e-5;
    coeff3aTph_n_[13] = 0.128350627676972 * 1.0e-2;
    coeff3aTph_n_[14] = 0.171219081377331 * 1.0e-1;
    coeff3aTph_n_[15] = -0.851007304583213 * 1.0e+1;
    coeff3aTph_n_[16] = -0.136513461629781 * 1.0e-1;
    coeff3aTph_n_[17] = -0.384460997596657 * 1.0e-5;
    coeff3aTph_n_[18] = 0.337423807911655 * 1.0e-2;
    coeff3aTph_n_[19] = -0.551624873066791;
    coeff3aTph_n_[20] = 0.729202277107470;
    coeff3aTph_n_[21] = -0.992522757376041 * 1.0e-2;
    coeff3aTph_n_[22] = -0.119308831407288;
    coeff3aTph_n_[23] = 0.793929190615421;
    coeff3aTph_n_[24] = 0.454270731799386;
    coeff3aTph_n_[25] = 0.209998591259910;
    coeff3aTph_n_[26] = -0.642109823904738 * 1.0e-2;
    coeff3aTph_n_[27] = -0.235155868604540 * 1.0e-1;
    coeff3aTph_n_[28] = 0.252233108341612 * 1.0e-2;
    coeff3aTph_n_[29] = -0.764885133368119 * 1.0e-2;
    coeff3aTph_n_[30] = 0.136176427574291 * 1.0e-1;
    coeff3aTph_n_[31] = -0.133027883575669 * 1.0e-1;

    temperature_ref3bTph_ = 860.;
    pressure_ref3bTph_ = 100. * 1.0e+6;
    enthalpy_ref3bTph_ = 2800. * 1.0e+3;

    coeff3bTph_I_[0] = 0;
    // backward T(p,h) coefficient region 3b I_i
    coeff3bTph_I_[1] = -12;
    coeff3bTph_I_[2] = -12;
    coeff3bTph_I_[3] = -10;
    coeff3bTph_I_[4] = -10;
    ...
    coeff3bTph_J_[0] = 0;
    // backward T(p,h) coefficient region 3b J_i
    coeff3bTph_J_[1] = 0;
    coeff3bTph_J_[2] = 1;
    coeff3bTph_J_[3] = 0;
    coeff3bTph_J_[4] = 1;
    ...
    coeff3bTph_n_[0] = 0.;
    // backward T(p,h) coefficient region 3b n_i
    coeff3bTph_n_[1] = 0.323254573644920 * 1.0e-4;
    coeff3bTph_n_[2] = -0.127575556587181 * 1.0e-3;
    coeff3bTph_n_[3] = -0.475851877356068 * 1.0e-3;
    coeff3bTph_n_[4] = 0.156183014181602 * 1.0e-2;
    coeff3bTph_n_[5] = 0.105724860113781;
    coeff3bTph_n_[6] = -0.858514221132534 * 1.0e+2;
    coeff3bTph_n_[7] = 0.724140095480911 * 1.0e+3;
    coeff3bTph_n_[8] = 0.296475810273257 * 1.0e-2;
    coeff3bTph_n_[9] = -0.592721983365988 * 1.0e-2;
    coeff3bTph_n_[10] = -0.126305422818666 * 1.0e-1;
    coeff3bTph_n_[11] = -0.115716196364853;
    coeff3bTph_n_[12] = 0.849000969739595 * 1.0e+2;
    coeff3bTph_n_[13] = -0.108602260086615 * 1.0e-1;
    coeff3bTph_n_[14] = 0.154304475328851 * 1.0e-1;
    coeff3bTph_n_[15] = 0.750455441524466 * 1.0e-1;
    coeff3bTph_n_[16] = 0.252520973612982 * 1.0e-1;
    coeff3bTph_n_[17] = -0.602507901232996 * 1.0e-1;
    coeff3bTph_n_[18] = -0.307622221350501 * 1.0e+1;
    coeff3bTph_n_[19] = -0.574011959864879 * 1.0e-1;
    coeff3bTph_n_[20] = 0.503471360939849 * 1.0e+1;
    coeff3bTph_n_[21] = -0.925081888584834;
    coeff3bTph_n_[22] = 0.391733882917546 * 1.0e+1;
    coeff3bTph_n_[23] = -0.773146007130190 * 1.0e+2;
    coeff3bTph_n_[24] = 0.949308762098587 * 1.0e+4;
    coeff3bTph_n_[25] = -0.141043719679409 * 1.0e+7;
    coeff3bTph_n_[26] = 0.849166230819026 * 1.0e+7;
    coeff3bTph_n_[27] = 0.861095729446704;
    coeff3bTph_n_[28] = 0.323346442811720;
    coeff3bTph_n_[29] = 0.873281936020439;
    coeff3bTph_n_[30] = -0.436653048526683;
    coeff3bTph_n_[31] = 0.286596714529479;
    coeff3bTph_n_[32] = -0.131778331276228;
    coeff3bTph_n_[33] = 0.676682064330275 * 1.0e-2;

    temperature_ref3aTps_ = 760.;
    pressure_ref3aTps_ = 100. * 1.0e+6;
    entropy_ref3aTps_ = 4.4 * 1.0e+3;

    coeff3aTps_I_[0] = 0;
    // backward T(p,s) coefficient region 3a I_i
    coeff3aTps_I_[1] = -12;
    coeff3aTps_I_[2] = -12;
    coeff3aTps_I_[3] = -10;
    coeff3aTps_I_[4] = -10;
    ...
    coeff3aTps_J_[0] = 0;
    // backward T(p,s) coefficient region 3a J_i
    coeff3aTps_J_[1] = 28;
    coeff3aTps_J_[2] = 32;
    coeff3aTps_J_[3] = 4;
    coeff3aTps_J_[4] = 10;
    ...
    coeff3aTps_n_[0] = 0.;
    // backward T(p,s) coefficient region 3a n_i
    coeff3aTps_n_[1] = 0.150042008263875 * 1.0e+10;
    coeff3aTps_n_[2] = -0.159397258480424 * 1.0e+12;
    coeff3aTps_n_[3] = 0.502181140217975 * 1.0e-3;
    coeff3aTps_n_[4] = -0.672057767855466 * 1.0e+2;
    coeff3aTps_n_[5] = 0.145058545404456 * 1.0e+4;
    coeff3aTps_n_[6] = -0.823889534888890 * 1.0e+4;
    coeff3aTps_n_[7] = -0.154852214233853;
    coeff3aTps_n_[8] = 0.112305046746695 * 1.0e+2;
    coeff3aTps_n_[9] = -0.297000213482822 * 1.0e+2;
    coeff3aTps_n_[10] = 0.438565132635495 * 1.0e+11;
    coeff3aTps_n_[11] = 0.137837838635464 * 1.0e-2;
    coeff3aTps_n_[12] = -0.297478527157462 * 1.0e+1;
    coeff3aTps_n_[13] = 0.971777947349413 * 1.0e+13;
    coeff3aTps_n_[14] = -0.571527767052398 * 1.0e-4;
    coeff3aTps_n_[15] = 0.288307949778420 * 1.0e+5;
    coeff3aTps_n_[16] = -0.744428289262703 * 1.0e+14;
    coeff3aTps_n_[17] = 0.128017324848921 * 1.0e+2;
    coeff3aTps_n_[18] = -0.368275545889071 * 1.0e+3;
    coeff3aTps_n_[19] = 0.664768904779177 * 1.0e+16;
    coeff3aTps_n_[20] = 0.449359251958880 * 1.0e-1;
    coeff3aTps_n_[21] = -0.422897836099655 * 1.0e+1;
    coeff3aTps_n_[22] = -0.240614376434179;
    coeff3aTps_n_[23] = -0.474341365254924 * 1.0e+1;
    coeff3aTps_n_[24] = 0.724093999126110;
    coeff3aTps_n_[25] = 0.923874349695897;
    coeff3aTps_n_[26] = 0.399043655281015 * 1.0e+1;
    coeff3aTps_n_[27] = 0.384066651868009 * 1.0e-1;
    coeff3aTps_n_[28] = -0.359344365571848 * 1.0e-2;
    coeff3aTps_n_[29] = -0.735196448821653;
    coeff3aTps_n_[30] = 0.188367048396131;
    coeff3aTps_n_[31] = 0.141064266818704 * 1.0e-3;
    coeff3aTps_n_[32] = -0.257418501496337 * 1.0e-2;
    coeff3aTps_n_[33] = 0.123220024851555 * 1.0e-2;

    temperature_ref3bTps_ = 860.;
    pressure_ref3bTps_ = 100. * 1.0e+6;
    entropy_ref3bTps_ = 5.3 * 1.0e+3;

    coeff3bTps_I_[0] = 0;
    // backward T(p,s) coefficient region 3b I_i
    coeff3bTps_I_[1] = -12;
    coeff3bTps_I_[2] = -12;
    coeff3bTps_I_[3] = -12;
    coeff3bTps_I_[4] = -12;
    ...
    coeff3bTps_J_[0] = 0;
    // backward T(p,s) coefficient region 3b J_i
    coeff3bTps_J_[1] = 1;
    coeff3bTps_J_[2] = 3;
    coeff3bTps_J_[3] = 4;
    coeff3bTps_J_[4] = 7;
    ...
    coeff3bTps_n_[0] = 0.;
    // backward T(p,s) coefficient region 3b n_i
    coeff3bTps_n_[1] = 0.527111701601660;
    coeff3bTps_n_[2] = -0.401317830052742 * 1.0e+2;
    coeff3bTps_n_[3] = 0.153020073134484 * 1.0e+3;
    coeff3bTps_n_[4] = -0.224799398218827 * 1.0e+4;
    coeff3bTps_n_[5] = -0.193993484669048;
    coeff3bTps_n_[6] = -0.140467557893768 * 1.0e+1;
    coeff3bTps_n_[7] = 0.426799878114024 * 1.0e+2;
    coeff3bTps_n_[8] = 0.752810643416743;
    coeff3bTps_n_[9] = 0.226657238616417 * 1.0e+2;
    coeff3bTps_n_[10] = -0.622873556909932 * 1.0e+3;
    coeff3bTps_n_[11] = -0.660823667935396;
    coeff3bTps_n_[12] = 0.841267087271658;
    coeff3bTps_n_[13] = -0.253717501764397 * 1.0e+2;
    coeff3bTps_n_[14] = 0.485708963532948 * 1.0e+3;
    coeff3bTps_n_[15] = 0.880531517490555 * 1.0e+3;
    coeff3bTps_n_[16] = 0.265015592794626 * 1.0e+7;
    coeff3bTps_n_[17] = -0.359287150025783;
    coeff3bTps_n_[18] = -0.656991567673753 * 1.0e+3;
    coeff3bTps_n_[19] = 0.241768149185367 * 1.0e+1;
    coeff3bTps_n_[20] = 0.856873461222588;
    coeff3bTps_n_[21] = 0.655143675313458;
    coeff3bTps_n_[22] = -0.213535213206406;
    coeff3bTps_n_[23] = 0.562974957606348 * 1.0e-2;
    coeff3bTps_n_[24] = -0.316955725450471 * 1.0e+15;
    coeff3bTps_n_[25] = -0.699997000152457 * 1.0e-3;
    coeff3bTps_n_[26] = 0.119845803210767 * 1.0e-1;
    coeff3bTps_n_[27] = 0.193848122022095 * 1.0e-4;
    coeff3bTps_n_[28] = -0.215095749182309 * 1.0e-4;
